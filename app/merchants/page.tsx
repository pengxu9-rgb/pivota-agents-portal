              ...
              <div key={merchant.id} className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <p className="text-lg font-bold text-gray-900">${(merchant.gmv / 1000).toFixed(1)}k</p>
                  </div>
                  <div>
                ...
                <div className="flex items-center space-x-2">
                  <button className="flex-1 flex items-center justify-center space-x-1 px-3 py-2 border rounded-lg hover:bg-gray-50 text-sm">
